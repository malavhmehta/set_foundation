...
export const up = {
  ...
  schedule: {
    ...
    columns: [
      ...
      ["1:35 pm - 1:55 pm", "Mingde Yin", "Engineering Science"],
      ["1:55 pm - 2:15 pm", "Wanda Song", "Software Engineering	"],
      ["2:15 pm - 2:35 pm", "Anthony Luo", "Dev Degree Program"],
      ["2:35 pm - 2:55 pm", "Amar Jasarbasic", "Career opportunities in SE"],
      ["2:55 pm - 3:15 pm", "Professor William Bishop", "University of Waterloo Faculty of Engineering"],
      ["3:15 pm - 3:35 pm", "William Wang", "Computer Engineering"],
      ["3:35 pm - 3:55 pm", "Victor Wang", "Computer Science"],
